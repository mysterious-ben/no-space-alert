...
CPU_PCT_WARNING: float = env.float("CPU_PCT_WARNING")
CPU_PCT_ERROR: float = env.float("CPU_PCT_ERROR")
CPU_WARNING_INC: float = env.float("CPU_WARNING_INC")
CPU_ERROR_INC: float = env.float("CPU_ERROR_INC")
...
ALERT_WHEN_OK: bool = env.bool("ALERT_WHEN_OK")
LOG_FILE_LEVEL: str = env.str("LOG_FILE_LEVEL")
